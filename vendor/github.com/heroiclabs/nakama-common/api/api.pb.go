...
const (
	...
	OverrideOperator_NO_OVERRIDE OverrideOperator = 0
	// Override the leaderboard operator with BEST.
	OverrideOperator_BEST OverrideOperator = 1
	// Override the leaderboard operator with SET.
	OverrideOperator_SET OverrideOperator = 2
	// Override the leaderboard operator with INCREMENT.
	OverrideOperator_INCREMENT OverrideOperator = 3
	// Override the leaderboard operator with DECREMENT.
	OverrideOperator_DECREMENT OverrideOperator = 4
)

// Enum value maps for OverrideOperator.
var (
	OverrideOperator_name = map[int32]string{
		0: "NO_OVERRIDE",
		1: "BEST",
		2: "SET",
		3: "INCREMENT",
	...
	OverrideOperator_value = map[string]int32{
		"NO_OVERRIDE": 0,
		"BEST":        1,
		"SET":         2,
		"INCREMENT":   3,
...
func (x OverrideOperator) Enum() *OverrideOperator {
	p := new(OverrideOperator)
	*p = x
	return p
}

func (x OverrideOperator) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OverrideOperator) Descriptor() protoreflect.EnumDescriptor {
	return file_api_proto_enumTypes[0].Descriptor()
}

func (OverrideOperator) Type() protoreflect.EnumType {
	return &file_api_proto_enumTypes[0]
}

func (x OverrideOperator) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OverrideOperator.Descriptor instead.
func (OverrideOperator) EnumDescriptor() ([]byte, []int) {
...
type Leaderboard struct {
	...
	PrevReset uint32 `protobuf:"varint,7,opt,name=prev_reset,json=prevReset,proto3" json:"prev_reset,omitempty"`
	// The UNIX time when the leaderboard is next playable. A computed value.
	NextReset uint32 `protobuf:"varint,8,opt,name=next_reset,json=nextReset,proto3" json:"next_reset,omitempty"`
	// Additional information stored as a JSON object.
	...
	Authoritative bool `protobuf:"varint,11,opt,name=authoritative,proto3" json:"authoritative,omitempty"`
}
...
type Tournament struct {
	...
	MaxSize uint32 `protobuf:"varint,8,opt,name=max_size,json=maxSize,proto3" json:"max_size,omitempty"`
	// The maximum score updates allowed per player for the current tournament.
	MaxNumScore uint32 `protobuf:"varint,9,opt,name=max_num_score,json=maxNumScore,proto3" json:"max_num_score,omitempty"`
	// True if the tournament is active and can enter. A computed value.
	CanEnter bool `protobuf:"varint,10,opt,name=can_enter,json=canEnter,proto3" json:"can_enter,omitempty"`
	// The UNIX time when the tournament stops being active until next reset. A computed value.
	EndActive uint32 `protobuf:"varint,11,opt,name=end_active,json=endActive,proto3" json:"end_active,omitempty"`
	// The UNIX time when the tournament was last reset. A computed value.
	PrevReset uint32 `protobuf:"varint,12,opt,name=prev_reset,json=prevReset,proto3" json:"prev_reset,omitempty"`
	// The UNIX time when the tournament is next playable. A computed value.
	NextReset uint32 `protobuf:"varint,13,opt,name=next_reset,json=nextReset,proto3" json:"next_reset,omitempty"`
	// Additional information stored as a JSON object.
	...
	StartActive uint32 `protobuf:"varint,19,opt,name=start_active,json=startActive,proto3" json:"start_active,omitempty"`
}
...
type WriteLeaderboardRecordRequest_LeaderboardRecordWrite struct {
	...
	// Operator override.
	Operator OverrideOperator `protobuf:"varint,4,opt,name=operator,proto3,enum=nakama.api.OverrideOperator" json:"operator,omitempty"`
}
...
func (x *WriteLeaderboardRecordRequest_LeaderboardRecordWrite) GetOperator() OverrideOperator {
	if x != nil {
		return x.Operator
	}
	return OverrideOperator_NO_OVERRIDE
}
...
func (x *WriteTournamentRecordRequest_TournamentRecordWrite) GetOperator() OverrideOperator {
	if x != nil {
		return x.Operator
	}
	return OverrideOperator_NO_OVERRIDE
...
var file_api_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x73, 0x22, 0xe9, 0x02, 0x0a, 0x0b, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x62, 0x6f,
	...
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x63,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x6f, 0x72, 0x74, 0x5f,
	...
	,
	...
	0x72, 0x64, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64,
	...
	0x1a, 0x0a, 0x08, 0x73, 0x75, 0x62, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x08, 0x73, 0x75, 0x62, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x6e,
	0x75, 0x6d, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
	0x6e, 0x75, 0x6d, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61,
	...
	,
	...
	0x65, 0x72, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x07, 0x72,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x42, 0x0a, 0x0d, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f,
	...
	0x72, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x0c, 0x6f, 0x77,
	0x6e, 0x65, 0x72, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x6e, 0x65,
	...
	0x72, 0x65, 0x76, 0x5f, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0a, 0x70, 0x72, 0x65, 0x76, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x2e, 0x0a, 0x11,
	...
	0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x72, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x47, 0x72,
	...
	0x6c, 0x75, 0x65, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0xb0, 0x01, 0x0a, 0x15, 0x4c,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xd5, 0x01,
	...
	0x78, 0x70, 0x69, 0x72, 0x79, 0x22, 0xe3, 0x01, 0x0a, 0x1d, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x65,
	...
	0x09, 0x52, 0x08, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x73, 0x12, 0x31, 0x0a, 0x05, 0x6c,
	...
	0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x12, 0x33, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x49, 0x6e, 0x74, 0x36, 0x34, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x22, 0xe1, 0x02, 0x0a, 0x12,
	...
	,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x49, 0x6e, 0x74,
	0x33, 0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x29,
	0x0a, 0x10, 0x63, 0x61, 0x63, 0x68, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x63, 0x75, 0x72, 0x73,
	0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x63, 0x61, 0x63, 0x68, 0x65, 0x61,
	0x62, 0x6c, 0x65, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x9f, 0x01, 0x0a, 0x19, 0x4c, 0x69,
	0x73, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xd2, 0x01, 0x0a, 0x27,
	...
	0x74, 0x6f, 0x75, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x05,
	...
	0x28, 0x09, 0x52, 0x07, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x12, 0x33, 0x0a, 0x06, 0x65,
	0x78, 0x70, 0x69, 0x72, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x49, 0x6e,
	0x74, 0x36, 0x34, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79,
	0x22, 0xe0, 0x01, 0x0a, 0x1c, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x6f, 0x75, 0x72, 0x6e, 0x61, 0x6d,
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f,
	...
	,
	...
	0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xae, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69,
	...
	0x33, 0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x16,
	0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xd0, 0x01, 0x0a, 0x05, 0x4d, 0x61, 0x74, 0x63, 0x68,
	...
	0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x69, 0x63,
	0x6b, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x74, 0x69,
	0x63, 0x6b, 0x52, 0x61, 0x74, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x68, 0x61,
	0x6e, 0x64, 0x6c, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x38, 0x0a, 0x09, 0x4d, 0x61, 0x74,
	...
	,
	...
	0x6b, 0x65, 0x6e, 0x22, 0xd8, 0x02, 0x0a, 0x0d, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x4f,
	...
	,
	...
	,
	...
	0x16, 0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x82, 0x05, 0x0a, 0x0a, 0x54, 0x6f, 0x75, 0x72,
	...
	,
	...
	,
	...
	0x64, 0x73, 0x12, 0x42, 0x0a, 0x0d, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6e, 0x61, 0x6b, 0x61,
	0x6d, 0x61, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x62, 0x6f, 0x61,
	0x72, 0x64, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x0c, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x52,
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x63,
	...
	0x65, 0x76, 0x43, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xfb, 0x02, 0x0a, 0x14, 0x55, 0x70, 0x64,
	...
	0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x38, 0x0a, 0x1c, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x12, 0x39, 0x0a, 0x05, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x6e, 0x61, 0x6b, 0x61, 0x6d, 0x61, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x64, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61,
	0x73, 0x65, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x05, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x12,
	...
	,
	...
	0x63, 0x68, 0x61, 0x73, 0x65, 0x73, 0x22, 0x76, 0x0a, 0x0c, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0xc3,
	0x02, 0x0a, 0x1d, 0x57, 0x72, 0x69, 0x74, 0x65, 0x4c, 0x65, 0x61, 0x64, 0x65, 0x72, 0x62, 0x6f,
	...
	0x62, 0x6f, 0x61, 0x72, 0x64, 0x49, 0x64, 0x12, 0x58, 0x0a, 0x06, 0x72, 0x65, 0x63, 0x6f, 0x72,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x6e, 0x61, 0x6b, 0x61, 0x6d, 0x61,
	...
	,
	...
	,
	...
	0x63, 0x74, 0x73, 0x22, 0xbd, 0x02, 0x0a, 0x1c, 0x57, 0x72, 0x69, 0x74, 0x65, 0x54, 0x6f, 0x75,
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x71,
	...
	0x72, 0x6e, 0x61, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x56, 0x0a, 0x06, 0x72, 0x65, 0x63,
	0x6f, 0x72, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x6e, 0x61, 0x6b, 0x61,
	...
	,
	...
	0x61, 0x2d, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0xaa, 0x02, 0x0f, 0x4e,
...
var file_api_proto_goTypes = []interface{}{
	(OverrideOperator)(0),                            // 0: nakama.api.OverrideOperator
...
var file_api_proto_depIdxs = []int32{
	...
	122, // 56: nakama.api.Leaderboard.create_time:type_name -> google.protobuf.Timestamp
	53,  // 57: nakama.api.LeaderboardList.leaderboards:type_name -> nakama.api.Leaderboard
	125, // 58: nakama.api.LeaderboardRecord.username:type_name -> google.protobuf.StringValue
	122, // 59: nakama.api.LeaderboardRecord.create_time:type_name -> google.protobuf.Timestamp
	122, // 60: nakama.api.LeaderboardRecord.update_time:type_name -> google.protobuf.Timestamp
	122, // 61: nakama.api.LeaderboardRecord.expiry_time:type_name -> google.protobuf.Timestamp
	55,  // 62: nakama.api.LeaderboardRecordList.records:type_name -> nakama.api.LeaderboardRecord
	55,  // 63: nakama.api.LeaderboardRecordList.owner_records:type_name -> nakama.api.LeaderboardRecord
	12,  // 64: nakama.api.LinkFacebookRequest.account:type_name -> nakama.api.AccountFacebook
	123, // 65: nakama.api.LinkFacebookRequest.sync:type_name -> google.protobuf.BoolValue
	16,  // 66: nakama.api.LinkSteamRequest.account:type_name -> nakama.api.AccountSteam
	123, // 67: nakama.api.LinkSteamRequest.sync:type_name -> google.protobuf.BoolValue
	124, // 68: nakama.api.ListChannelMessagesRequest.limit:type_name -> google.protobuf.Int32Value
	123, // 69: nakama.api.ListChannelMessagesRequest.forward:type_name -> google.protobuf.BoolValue
	124, // 70: nakama.api.ListFriendsRequest.limit:type_name -> google.protobuf.Int32Value
	124, // 71: nakama.api.ListFriendsRequest.state:type_name -> google.protobuf.Int32Value
	124, // 72: nakama.api.ListGroupsRequest.limit:type_name -> google.protobuf.Int32Value
	124, // 73: nakama.api.ListGroupUsersRequest.limit:type_name -> google.protobuf.Int32Value
	124, // 74: nakama.api.ListGroupUsersRequest.state:type_name -> google.protobuf.Int32Value
	126, // 75: nakama.api.ListLeaderboardRecordsAroundOwnerRequest.limit:type_name -> google.protobuf.UInt32Value
	127, // 76: nakama.api.ListLeaderboardRecordsAroundOwnerRequest.expiry:type_name -> google.protobuf.Int64Value
	124, // 77: nakama.api.ListLeaderboardRecordsRequest.limit:type_name -> google.protobuf.Int32Value
	127, // 78: nakama.api.ListLeaderboardRecordsRequest.expiry:type_name -> google.protobuf.Int64Value
	124, // 79: nakama.api.ListMatchesRequest.limit:type_name -> google.protobuf.Int32Value
	123, // 80: nakama.api.ListMatchesRequest.authoritative:type_name -> google.protobuf.BoolValue
	125, // 81: nakama.api.ListMatchesRequest.label:type_name -> google.protobuf.StringValue
	124, // 82: nakama.api.ListMatchesRequest.min_size:type_name -> google.protobuf.Int32Value
	124, // 83: nakama.api.ListMatchesRequest.max_size:type_name -> google.protobuf.Int32Value
	125, // 84: nakama.api.ListMatchesRequest.query:type_name -> google.protobuf.StringValue
	124, // 85: nakama.api.ListNotificationsRequest.limit:type_name -> google.protobuf.Int32Value
	124, // 86: nakama.api.ListStorageObjectsRequest.limit:type_name -> google.protobuf.Int32Value
	126, // 87: nakama.api.ListTournamentRecordsAroundOwnerRequest.limit:type_name -> google.protobuf.UInt32Value
	127, // 88: nakama.api.ListTournamentRecordsAroundOwnerRequest.expiry:type_name -> google.protobuf.Int64Value
	124, // 89: nakama.api.ListTournamentRecordsRequest.limit:type_name -> google.protobuf.Int32Value
	127, // 90: nakama.api.ListTournamentRecordsRequest.expiry:type_name -> google.protobuf.Int64Value
	126, // 91: nakama.api.ListTournamentsRequest.category_start:type_name -> google.protobuf.UInt32Value
	126, // 92: nakama.api.ListTournamentsRequest.category_end:type_name -> google.protobuf.UInt32Value
	126, // 93: nakama.api.ListTournamentsRequest.start_time:type_name -> google.protobuf.UInt32Value
	126, // 94: nakama.api.ListTournamentsRequest.end_time:type_name -> google.protobuf.UInt32Value
	124, // 95: nakama.api.ListTournamentsRequest.limit:type_name -> google.protobuf.Int32Value
	124, // 96: nakama.api.ListUserGroupsRequest.limit:type_name -> google.protobuf.Int32Value
	124, // 97: nakama.api.ListUserGroupsRequest.state:type_name -> google.protobuf.Int32Value
	125, // 98: nakama.api.Match.label:type_name -> google.protobuf.StringValue
	73,  // 99: nakama.api.MatchList.matches:type_name -> nakama.api.Match
	122, // 100: nakama.api.Notification.create_time:type_name -> google.protobuf.Timestamp
	75,  // 101: nakama.api.NotificationList.notifications:type_name -> nakama.api.Notification
	79,  // 102: nakama.api.ReadStorageObjectsRequest.object_ids:type_name -> nakama.api.ReadStorageObjectId
	122, // 103: nakama.api.StorageObject.create_time:type_name -> google.protobuf.Timestamp
	122, // 104: nakama.api.StorageObject.update_time:type_name -> google.protobuf.Timestamp
	84,  // 105: nakama.api.StorageObjectAcks.acks:type_name -> nakama.api.StorageObjectAck
	83,  // 106: nakama.api.StorageObjects.objects:type_name -> nakama.api.StorageObject
	83,  // 107: nakama.api.StorageObjectList.objects:type_name -> nakama.api.StorageObject
	122, // 108: nakama.api.Tournament.create_time:type_name -> google.protobuf.Timestamp
	122, // 109: nakama.api.Tournament.start_time:type_name -> google.protobuf.Timestamp
	122, // 110: nakama.api.Tournament.end_time:type_name -> google.protobuf.Timestamp
	88,  // 111: nakama.api.TournamentList.tournaments:type_name -> nakama.api.Tournament
	55,  // 112: nakama.api.TournamentRecordList.records:type_name -> nakama.api.LeaderboardRecord
	55,  // 113: nakama.api.TournamentRecordList.owner_records:type_name -> nakama.api.LeaderboardRecord
	125, // 114: nakama.api.UpdateAccountRequest.username:type_name -> google.protobuf.StringValue
	125, // 115: nakama.api.UpdateAccountRequest.display_name:type_name -> google.protobuf.StringValue
	125, // 116: nakama.api.UpdateAccountRequest.avatar_url:type_name -> google.protobuf.StringValue
	125, // 117: nakama.api.UpdateAccountRequest.lang_tag:type_name -> google.protobuf.StringValue
	125, // 118: nakama.api.UpdateAccountRequest.location:type_name -> google.protobuf.StringValue
	125, // 119: nakama.api.UpdateAccountRequest.timezone:type_name -> google.protobuf.StringValue
	125, // 120: nakama.api.UpdateGroupRequest.name:type_name -> google.protobuf.StringValue
	125, // 121: nakama.api.UpdateGroupRequest.description:type_name -> google.protobuf.StringValue
	125, // 122: nakama.api.UpdateGroupRequest.lang_tag:type_name -> google.protobuf.StringValue
	125, // 123: nakama.api.UpdateGroupRequest.avatar_url:type_name -> google.protobuf.StringValue
	123, // 124: nakama.api.UpdateGroupRequest.open:type_name -> google.protobuf.BoolValue
	122, // 125: nakama.api.User.create_time:type_name -> google.protobuf.Timestamp
	122, // 126: nakama.api.User.update_time:type_name -> google.protobuf.Timestamp
	119, // 127: nakama.api.UserGroupList.user_groups:type_name -> nakama.api.UserGroupList.UserGroup
	93,  // 128: nakama.api.Users.users:type_name -> nakama.api.User
	4,   // 129: nakama.api.ValidatedPurchase.store:type_name -> nakama.api.ValidatedPurchase.Store
	122, // 130: nakama.api.ValidatedPurchase.purchase_time:type_name -> google.protobuf.Timestamp
	122, // 131: nakama.api.ValidatedPurchase.create_time:type_name -> google.protobuf.Timestamp
	122, // 132: nakama.api.ValidatedPurchase.update_time:type_name -> google.protobuf.Timestamp
	5,   // 133: nakama.api.ValidatedPurchase.environment:type_name -> nakama.api.ValidatedPurchase.Environment
	99,  // 134: nakama.api.ValidatePurchaseResponse.validated_purchases:type_name -> nakama.api.ValidatedPurchase
	99,  // 135: nakama.api.PurchaseList.validated_purchases:type_name -> nakama.api.ValidatedPurchase
	120, // 136: nakama.api.WriteLeaderboardRecordRequest.record:type_name -> nakama.api.WriteLeaderboardRecordRequest.LeaderboardRecordWrite
	124, // 137: nakama.api.WriteStorageObject.permission_read:type_name -> google.protobuf.Int32Value
	124, // 138: nakama.api.WriteStorageObject.permission_write:type_name -> google.protobuf.Int32Value
	103, // 139: nakama.api.WriteStorageObjectsRequest.objects:type_name -> nakama.api.WriteStorageObject
	121, // 140: nakama.api.WriteTournamentRecordRequest.record:type_name -> nakama.api.WriteTournamentRecordRequest.TournamentRecordWrite
	93,  // 141: nakama.api.GroupUserList.GroupUser.user:type_name -> nakama.api.User
	124, // 142: nakama.api.GroupUserList.GroupUser.state:type_name -> google.protobuf.Int32Value
	45,  // 143: nakama.api.UserGroupList.UserGroup.group:type_name -> nakama.api.Group
	124, // 144: nakama.api.UserGroupList.UserGroup.state:type_name -> google.protobuf.Int32Value
	0,   // 145: nakama.api.WriteLeaderboardRecordRequest.LeaderboardRecordWrite.operator:type_name -> nakama.api.OverrideOperator
	0,   // 146: nakama.api.WriteTournamentRecordRequest.TournamentRecordWrite.operator:type_name -> nakama.api.OverrideOperator
